...
function Open-AzurePostgresDb {
    "Connecting to db..."
    $env:PGPASSWORD =  "Jp83p9FdhKR2bnQhUdl6" #Get-SecretParameter dbPassword
...
function Import-AzurePostgresDbDump($dumpFile) {
    "Importing db dump..."
    $dbPassword = "Jp83p9FdhKR2bnQhUdl6" #Get-SecretParameter dbPassword
    $env:PGPASSWORD = "2dD1A5O5x8LxU0WkvMPn" #Get-SecretParameter dbAdminPassword
